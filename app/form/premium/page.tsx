...
export default function PremiumPlanForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      const packagePrice = data.packageDuration === "3 months" ? "₹14,999" : "₹26,999"
      const message = `Hi FitneX! I'm interested in joining the Premium Plan.
        ...
        <div className="container mx-auto px-4 lg:px-6 text-center">
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <p className="text-xl text-gray-600">
              Get everything from Standard Plan plus daily meal tracking, habit tracker, and dedicated doctor support for maximum results.
            </p>
            <div className="flex items-center justify-center gap-6 pt-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">₹14,999</div>
                <div className="text-sm text-gray-600">3 months</div>
              </div>
              <div className="text-gray-400">|</div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">₹26,999</div>
          ...
          <div className="max-w-2xl mx-auto">
            <Card className="p-8 border-2 border-green-200">
              <CardHeader className="p-0 mb-6">
                <CardTitle className="text-2xl">Premium Plan Application</CardTitle>
                <CardDescription>
                          ...
                          <FormControl>
                            ...
                            >
                              <div className="flex items-center space-x-2">
                                <RadioGroupItem value="Yes" id="premium-married-yes" />
                                <Label htmlFor="premium-married-yes" className="cursor-pointer">Yes</Label>
                              </div>
                              <div className="flex items-center space-x-2">
                                <RadioGroupItem value="No" id="premium-married-no" />
                                <Label htmlFor="premium-married-no" className="cursor-pointer">No</Label>
                              </div>
                            </RadioGroup>
                          </FormControl>
                          <FormMessage />
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            <SelectContent>
                              <SelectItem value="3 months">3 months - ₹14,999</SelectItem>
                              <SelectItem value="6 months">6 months - ₹26,999 (Save ₹3,000)</SelectItem>
                            </SelectContent>
                          </Select>
                          <FormMessage />
                        </FormItem>
